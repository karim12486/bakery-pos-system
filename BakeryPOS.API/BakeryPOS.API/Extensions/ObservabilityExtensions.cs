...
public static class ObservabilityExtensions
{
    ...
    /// </summary>
    public static IHostBuilder AddBakeryPosSerilog(this IHostBuilder host)
    {
    ...
    /// </summary>
    public static IServiceCollection AddBakeryPosHealthChecks(this IServiceCollection services)
    {
