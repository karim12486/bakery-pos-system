...
public static class AuthenticationExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddBakeryPosAuthentication(this IServiceCollection services, IConfiguration config)
    {
        ...
        var tokenIssuer = config["AppSettings:TokenIssuer"] ?? "BakeryPOS.API";
        var tokenAudience = config["AppSettings:TokenAudience"] ?? "BakeryPOS.Client";
    ...
    /// </summary>
    public static IServiceCollection AddBakeryPosRateLimiting(this IServiceCollection services, IConfiguration config)
    {
