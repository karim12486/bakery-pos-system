...
public static class ApiExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddBakeryPosCors(this IServiceCollection services, IConfiguration config)
    {
    ...
    /// </summary>
    public static IServiceCollection AddBakeryPosApi(this IServiceCollection services)
    {
