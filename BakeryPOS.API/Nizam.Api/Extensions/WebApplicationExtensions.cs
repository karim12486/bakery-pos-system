...
using Nizam.Api.Common.Localization;
...
public static class WebApplicationExtensions
{
    ...
    /// </summary>
    public static WebApplication UseNizamPipeline(this WebApplication app)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "Nizam API V1");
    ...
    /// </summary>
    public static WebApplication MapNizamEndpoints(this WebApplication app)
    {
        app.MapControllers();
        app.MapNizamHubs();
    ...
    /// <c>Tenant.Locale</c>.
    /// </summary>
    public static WebApplication UseNizamLocalization(this WebApplication app)
    {
